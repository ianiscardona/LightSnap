...
export const Navbar = () => {
  ...
  return (
    <div className='fixed flex flex-col lg:flex-row lg:items-center lg:justify-between lg:pl-24 lg:pr-16 lg:py-3 py-4 w-full bg-black/[0.85] lg:bg-black/75 z-50'>
      <Link to='/'>
