          ...
          <div className='flex flex-col items-center justify-center font-["Inter"] gap-y-4 sm:gap-y-6 xl:scale-90'>
            ...
            <div className='flex items-center justify-center mx-8 mb-6 gap-x-3 lg:mb-0'>
              {currentIndex === 0 ?
                ...
                </Link>:<button onClick={previous} className="font-normal text-base sm:text-3xl text-center bg-[#ECF4EF] rounded-[30px] sm:rounded-[100px] px-10 sm:px-20 py-3 sm:py-4 text-black">
                          Previous
                        </button>
              }
              {currentIndex === InfoArray.length-1 ?
                ...
                </Link>:<button onClick={next} className='font-normal text-base sm:text-3xl text-center bg-[#1C0EB7] rounded-[30px] sm:rounded-[100px] px-10 sm:px-20 py-3 sm:py-4 text-white'>
                          Next
                        </button>
              }
            </div>
