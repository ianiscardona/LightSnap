  ...
  return (
    <div className="flex flex-col relative items-center w-full h-screen overflow-hidden font-[Inter]">
      <div className="relative ">
        <div
          className="relative flex flex-col justify-center items-center bg-[#B70E0E] rounded-b-full
                            -translate-y-[15rem] h-[700px] w-[700px]
                            sm:-translate-y-[27rem] sm:h-[942px] sm:w-[942px]  
                            md:-translate-y-[45rem] md:h-[1250px] md:w-[2500px]"
        >
          <div className=" absolute flex flex-col justify-center bottom-4 px-10 items-center">
            <div className="h-48 w-48  sm:h-48 sm:w-48 md:h-60 md:w-60">
              {" "}
              <img src={sad} className=" max-w-full min-w-full" />{" "}
            </div>
            <h1 className=" text-white text-3xl sm:text-4xl md:text-5xl font-medium py-10">
              Event Code not found.
            </h1>
            <h1 className=" font-normal text-white pb-10 sm:pb-20 text-sm sm:text-base md:text-xl">
      ...
      <div
        className="relative
                        ...
                        md:-translate-y-[45rem] md:px-[5.438rem]"
      >
        <div className="items-center flex flex-col">
          ...
          <Link to="/contact">
            <h1 className=" underline text-[#1C0EB7] font-medium text-sm sm:text-xl">
              Contact Us
            </h1>
          </Link>
        </div>
