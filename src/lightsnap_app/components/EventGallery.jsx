...
export const EventGallery = () => {
  ...
  return (
    <div className='relative'>
      <NavbarEvent />
      <div className={`${submit ? "h-full pb-12":"h-screen"} bg-black/90 pt-20 font-["Inter"] text-white`}>
          <div className='flex flex-col mt-3 mx-7 lg:mx-0 lg:ml-24 lg:mr-16 mb-4 justify-center'> 
            <p className='text-[#FAF9F6] font-bold text-5xl lg:text-7xl mb-5 lg:mb-10 text-center lg:text-left'>
              Event Gallery
            </p>
            {/* <form className='flex flex-col mx-[8%] lg:mx-0 gap-y-4'> */}
              ...
              <div className='flex flex-col gap-y-4 lg:flex-row'>
                ...
                {/* <input onClick={click} type="submit" value="SUBMIT" className='font-medium text-xs text-center py-4 lg:px-7 mx-[30%] lg:mx-5 border-2 border-[#FAF9F6] bg-[#1C0EB7] rounded-[40px]' /> */}
                <button onClick={click} className='font-medium text-xs text-center py-4 lg:px-7 mx-[30%] lg:mx-5 border-2 border-[#FAF9F6] bg-[#1C0EB7] rounded-[40px]'>
                  SUBMIT
                </button>
              </div>
            {/* </form> */}
          ...
          {/* Instruction */}
            <p className={`absolute bottom-0 w-full text-center font-bold text-xl lg:text-2xl mb-12 customInstruction ${submit ? "hidden":"block"}`}>
