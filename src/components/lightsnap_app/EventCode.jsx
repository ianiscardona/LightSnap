  ...
  return (
    <div className='flex flex-col relative items-center w-full h-screen overflow-hidden mx-auto'>
        ...
        <div className='flex flex-col justify-center items-center w-full px-[4rem]
                ...
                <input placeholder='Enter Event Code' className=' border-[1px] border-[#000000] text-[#000000] text-center rounded-xl w-80 h-12 sm:w-96 sm:h-16'></input>
                <div className=''>
                    <button className="flex items-center justify-center rounded-full w-28 h-10 sm:w-52 sm:h-16 text-white bg-[#1C0EB7] hover:bg-[#D7282F] focus:bg-[#D7282F] transition-colors duration-300">
                        <h2 className="font-bold text-base md:text-xl">Enter</h2>
                    </button>
                  </div>
