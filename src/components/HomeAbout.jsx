...
export const HomeAbout = () => {
  return(
    <div className="flex justify-center items-center lg:px-[126px] px-[2rem] py-[2rem] bg-orange-100 mx-auto rounded-xl shadow-md overflow-hidden lg:h-screen lg:w-full">
        <div className=" lg:flex">
            ...
            <div className=" lg:pl-[3rem] self-end text-right">
